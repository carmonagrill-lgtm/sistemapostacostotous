...
/* ══ INGREDIENTES ══ */
let ingredientes = [
  {id:1, nombre:'Carne de res', cat:'Proteínas', unidad:'Kg', stock:100, precioCompra:120},
  {id:2, nombre:'Cebolla', cat:'Verduras', unidad:'Kg', stock:50, precioCompra:10},
  {id:3, nombre:'Cilantro', cat:'Verduras', unidad:'Kg', stock:10, precioCompra:20},
  {id:4, nombre:'Tortilla de maíz', cat:'Misceláneos', unidad:'Pz', stock:1000, precioCompra:0.5},
  {id:5, nombre:'Tortilla de harina', cat:'Misceláneos', unidad:'Pz', stock:1000, precioCompra:1},
  {id:6, nombre:'Salsa verde', cat:'Misceláneos', unidad:'Lt', stock:20, precioCompra:50},
  {id:7, nombre:'Salsa roja', cat:'Misceláneos', unidad:'Lt', stock:20, precioCompra:50},
  // Agregar más según necesites
];

/* ══ RECETAS ══ */
let recetas = [
  {id:1, nombre:'Barbacoa', tipo:'receta', rinde:10, rindeUnit:'tacos', notas:'Receta para tacos de barbacoa', ingredientes:[
    {tipo:'ingr', refId:1, nombre:'Carne de res', cant:1, unidad:'Kg'},
    {tipo:'ingr', refId:2, nombre:'Cebolla', cant:0.2, unidad:'Kg'},
    {tipo:'ingr', refId:3, nombre:'Cilantro', cant:0.05, unidad:'Kg'},
    {tipo:'ingr', refId:4, nombre:'Tortilla de maíz', cant:1, unidad:'Pz'},
    {tipo:'ingr', refId:6, nombre:'Salsa verde', cant:0.1, unidad:'Lt'},
  ]},
  // Agregar más recetas según tus productos
];
